...
experiment_name = "experiment_har2"
...
# %% [markdown]
# # Step 6: Train the model and assess its performance
...
# %%
# Training function
def train_model(model, X_train, y_train, criterion, optimizer, n_epochs=100):
...
# Train the model
train_model(model2, X_train, y_train, criterion, optimizer)
